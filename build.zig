...
pub fn build(b: *std.Build) !void {
    ...
    if (target.query.os_tag == .emscripten) {
        const exe_lib = try rlz.emcc.compileForEmscripten(b, "zig-sweeper", "src/main.zig", target, optimize);
        ...
        const run_option = b.step("run", "Run zig-sweeper");
    ...
    const run_step = b.step("run", "Run zig-sweeper");
